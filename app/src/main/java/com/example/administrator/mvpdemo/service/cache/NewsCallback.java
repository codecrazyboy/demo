 ...
 */
package com.example.administrator.mvpdemo.service.cache;

import com.example.administrator.mvpdemo.service.entity.BaseResponse;
import com.example.administrator.mvpdemo.ui.utils.Convert;
...
public abstract class NewsCallback<T> extends AbsCallback<T> {
    ...
    public T convertResponse(Response response) throws Throwable {
        ...
        if (rawType == BaseResponse.class) {
            BaseResponse gankResponse = Convert.fromJson(jsonReader, type);
            if (gankResponse.books!=null) {
                response.close();
